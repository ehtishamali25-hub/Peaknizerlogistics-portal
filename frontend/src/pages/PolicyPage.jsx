...
const PolicyPage = () => {
  return (
    <WebsiteLayout>
      <main className="flex-1 py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          {/* Hero Section */}
          <div className="text-center mb-8 sm:mb-12">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Terms of Service & <span className="text-blue-600">3PL Policies</span>
            </h1>
            <div className="w-20 sm:w-24 h-1 bg-gradient-to-r from-blue-500 to-blue-400 mx-auto rounded-full" />
            <p className="text-gray-500 mt-4 text-sm sm:text-base">Last updated: {new Date().toLocaleDateString()}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="p-5 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
              ...
              <section className="group">
                ...
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Services Overview</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Client Responsibilities</h2>
                </div>
                <ul className="list-disc list-inside text-gray-700 space-y-1.5 sm:space-y-2 ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Inventory Receiving</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Order Fulfillment</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Storage & Fees</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Returns Handling</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Shipping & Carriers</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Liability Limitation</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Distributor Shipments</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                    <span className="text-blue-600 font-bold text-sm sm:text-base">11</span>
                  </div>
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Multi-Warehouse Operations</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              {/* Section 12 - Important Legal Clause (kept red for emphasis) */}
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                    <span className="text-blue-600 font-bold text-sm sm:text-base">13</span>
                  </div>
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Prohibited Products</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                    <span className="text-blue-600 font-bold text-sm sm:text-base">14</span>
                  </div>
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Account Suspension & Termination</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                    <span className="text-blue-600 font-bold text-sm sm:text-base">15</span>
                  </div>
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Policy Updates</h2>
                </div>
                <p className="text-gray-700 leading-relaxed ml-8 sm:ml-11 text-sm sm:text-base">
              ...
              <section className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                    <span className="text-blue-600 font-bold text-sm sm:text-base">16</span>
                  </div>
                ...
                <div className="ml-8 sm:ml-11 space-y-2 text-sm sm:text-base">
                  <p className="text-gray-700">For any questions regarding these Terms, please contact us:</p>
              ...
              <div className="pt-4 text-center text-xs sm:text-sm text-gray-500 border-t border-gray-200">
          ...
          <div className="mt-8 text-center">
            <Link to="/" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 transition text-sm sm:text-base font-medium">
