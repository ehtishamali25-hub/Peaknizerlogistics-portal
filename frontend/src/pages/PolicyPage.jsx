  ...
  return (
    <WebsiteLayout>
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-gray-300 space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-2">
              <li>
                If any client uses our warehouse address for illegal activities, we reserve the full right to immediately 
                hold all associated inventory and report the matter to relevant law enforcement authorities.
              </li>
              <li>
                If a client provides fake, misleading, or unauthorized shipping labels, we reserve the right to hold all 
                inventory and suspend services without notice.
              </li>
              <li>
                If counterfeit products are identified, or if a client fails to provide valid invoices or proof of product authenticity, 
                we reserve the right to hold inventory and initiate legal action.
              </li>
              <li>
