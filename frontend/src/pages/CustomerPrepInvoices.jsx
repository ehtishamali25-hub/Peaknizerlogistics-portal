                ...
                {invoices.map((invoice) => (
                  <tr key={invoice.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex space-x-2">
                        {invoice.has_excel && (
                          <button
                            onClick={() => downloadFile(
                              `http://localhost:8000/api/v1/downloads/shipping-details/${invoice.shipping_detail_id}/excel`,
                        ...
                        {invoice.has_pdf && (
                          <button
                            onClick={() => downloadFile(
                              `http://localhost:8000/api/v1/downloads/shipping-details/${invoice.shipping_detail_id}/pdf`,
                    ...
                    <td className="px-4 py-3">
                      <button
                        onClick={() => downloadFile(
                          `http://localhost:8000/api/v1/downloads/invoice/${invoice.id}`,
